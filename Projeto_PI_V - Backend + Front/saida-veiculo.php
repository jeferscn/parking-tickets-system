                    ...
                    <table class="tabela">
                        <form class="form" name="fmrpesquisa" id="frmpesquisa" method="POST">
                            <div class="filtro">
                                ...
                                <input type="text" name="placa" placeholder="Filtrar por placa" value="<?php echo @$_POST['placa'] ?>">
                            </div>
                            <div class="div-btn-gerar">
                                <button class="btn-gerar" type="submit" name="botao" value="Gerar">Gerar</button>
                            </div>
                            <br>
                        </form>
                    </table>
